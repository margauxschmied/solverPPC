...
public class AC6 implements AC{
    ...
    @Override
    public boolean init(Map<String, Variable> graph) { //TODO: probleme avec 3 variable
        this.graph=graph;
            ...
            if (support.get(variable.getKey()).size() == 0) {
                for (Map.Entry<String, Variable> var : graph.entrySet()) {
                    for (Contrainte c : var.getValue().getContraintes()) {
                        if (Objects.equals(c.getD2().getVar(), variable.getKey())) {
                            return false;
                        }
                    }
                }
            ...
            if (listDeSupportAUpdate != null) {
                for (Pair pair : listDeSupportAUpdate) {
                    ...
                    for (int j = 0; j < graph.get(pair.getVariable()).getContraintes().size(); j++) {
                        ...
                        if (found == -1
                                && graph.get(pair.getVariable()).getContraintes().get(j).getD1().getVar().equals(pair.getVariable())
                           ...
                           support.get(graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVar()).get(graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVal()).add(new Pair(pair.getVariable(), pair.getDomaine()));
                           found = 1;
                       }
            ...
            if (listDeSupportAUpdate != null) {
                for (Pair pair : listDeSupportAUpdate) {
                    ...
                    for (int j = 0; j < graph.get(pair.getVariable()).getContraintes().size(); j++) {
                        ...
                        else if((!graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVar().equals(de.get(de.size()-1).getVariable())
                                || !graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVal().equals(de.get(de.size()-1).getDomaine()))
                                && graph.get(pair.getVariable()).getContraintes().get(j).getD1().getVar().equals(pair.getVariable())
                                && graph.get(pair.getVariable()).getContraintes().get(j).getD1().getVal().equals(pair.getDomaine())){
                                //&& support.get(graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVar()).get(graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVal()).stream().noneMatch(o -> pair.getVariable().equals(o.getVariable()) && pair.getDomaine().equals(o.getDomaine()))){
                            support.get(graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVar()).get(graph.get(pair.getVariable()).getContraintes().get(j).getD2().getVal()).removeIf(o -> pair.getVariable().equals(o.getVariable()) && pair.getDomaine().equals(o.getDomaine()));
                            found = 1;
                        }
    ...
    public boolean validChoice(Stack<Pair> peek, String v, String d, List<Pair> DE) {
        return graph.get(peek.peek().getVariable()).getContraintes().stream().anyMatch(o -> peek.peek().getDomaine().equals(o.getD1().getVal())
                && v.equals(o.getD2().getVar()) && d.equals(o.getD2().getVal()));
