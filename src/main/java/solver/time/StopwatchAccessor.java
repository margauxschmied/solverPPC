...
public class StopwatchAccessor {
    ...
    public final long readElapsedNanoSeconds() {
        return System.nanoTime() - start;
    }

    public final long lastElapsedNanoSeconds() {
        return last;
    }

    public final long lastElapsedMilliSeconds() {
        return (last) / 1000000;
    }
    ...
    public final long elapsedMilliSeconds() {
        return (cumul) / 1000000;
    }

    public final double millionOperationPerSecond(long numOp) {
        return (numOp / (double) (elapsedNanoSeconds())) * 1000.;
    }

    public final long numberOfAccumulations() {
        return numCumuls;
    }
}